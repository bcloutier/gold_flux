...
use mpp_mod, only: stderr, mpp_error, mpp_clock_id, &
...
!-----------------------------------------------------------------------
character(len=128) :: version = '$Id: fv_physics.F90,v 18.0.2.1.2.1.2.1.2.2 2011/04/05 21:26:41 William.Cooke Exp $'
...
!                                                           trim(evalue)
      write( text,'(a,a)' ) 'Cannot read OMP_NUM_THREADS, defaults to  1', &
                                                           trim(evalue)
