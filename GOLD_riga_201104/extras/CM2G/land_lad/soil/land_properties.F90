...
character(len=128) :: version = '$Id: land_properties.F90,v 15.0 2007/08/14 04:00:11 fms Exp $'
...
type(horiz_interp_type) :: Interp_gw
...
!   </PUBLICROUTINE>
  ...
  character*80            input_format
  integer :: unit, ierr, i_cover_type, i_ground_type
  integer :: ii, jj, num_lon_input, num_lat_input, k
  real    :: wb_degrees ! western boundary of the input grid cells
  real    :: sb, wb, dx, dy, z_root
