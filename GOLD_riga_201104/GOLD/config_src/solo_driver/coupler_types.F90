...
! as the driver, and with GOLD it is used with GOLD_driver.
!</OVERVIEW>
!
!<DESCRIPTION>
! This module contains simplified type declarations for the coupler
...
!                         permit sign convention or unit conversion.
  ...
  call GOLD_error(FATAL,"The called version of extract_coupler_values does" // &
...
!                         permit sign convention or unit conversion.
  ...
  call GOLD_error(FATAL,"The called version of set_coupler_values does" // &
                 " nothing but issue this fatal error message.")
