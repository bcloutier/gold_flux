...
! unique metric terms used by GOLD_hor_visc.F90 to vary in 0, 1, or 2       
...
#   define KH_MAX_xx(i,j)       Kh_Max_xx(1,1)
#   define KH_MAX_xy(i,j)       Kh_Max_xy(1,1)
#   define AH_MAX_xx(i,j)       Ah_Max_xx(1,1)
#   define AH_MAX_xy(i,j)       Ah_Max_xy(1,1)
#else ! not CARTESIAN
# ifdef XYMETRICS_I_J
...
#   define KH_MAX_xx(i,j)       Kh_Max_xx(i,j)
#   define KH_MAX_xy(i,j)       Kh_Max_xy(i,j)
#   define AH_MAX_xx(i,j)       Ah_Max_xx(i,j)
#   define AH_MAX_xy(i,j)       Ah_Max_xy(i,j)
# else !not XYMETRICS_I_J
#  ifdef XYMETRICS_I
...
#   define KH_MAX_xx(i,j)       Kh_Max_xx(i,1)
#   define KH_MAX_xy(i,j)       Kh_Max_xy(i,1)
#   define AH_MAX_xx(i,j)       Ah_Max_xx(i,1)
#   define AH_MAX_xy(i,j)       Ah_Max_xy(i,1)
#  else ! must be XYMETRICS_J 
...
#   define KH_MAX_xx(i,j)       Kh_Max_xx(1,j)
#   define KH_MAX_xy(i,j)       Kh_Max_xy(1,j)
#   define AH_MAX_xx(i,j)       Ah_Max_xx(1,j)
#   define AH_MAX_xy(i,j)       Ah_Max_xy(1,j)
#  endif ! XYMETRICS_I
# endif ! XYMETRICS_I_J
#endif ! CARTESIAN
