module GOLD_ocmip2_co2calc_mod  !{
!***********************************************************************
...
public  :: GOLD_ocmip2_co2calc, CO2_dope_vector

character(len=128) :: version = '$Id: GOLD_OCMIP2_CO2calc.F90,v 1.1.2.2 2008/04/11 14:33:35 rwh Exp $'
...
!#######################################################################
! <SUBROUTINE NAME="GOLD_ocmip2_co2calc">
!
! <DESCRIPTION>
...
subroutine GOLD_ocmip2_co2calc(dope_vec, mask,                      &
...
end subroutine  GOLD_ocmip2_co2calc  !}
! </SUBROUTINE> NAME="GOLD_ocmip2_co2calc"
...
end module  GOLD_ocmip2_co2calc_mod  !}
